 ...
 * @desc Lấy danh sách người tham gia của một khóa học
 * @access Chỉ Admin, Manager
 */
router.get("/:courseId/enrollments", authorizeRoles(["Admin", "Manager"]), courseController.getCourseEnrollments);
