...
const AppointmentCalendar: React.FC<AppointmentCalendarProps> = ({ counselorId }) => {
  ...
  const handleConfirmBooking = () => {
    alert(`Appointment booked with counselor #${counselorId} on ${selectedDate?.toLocaleDateString()} at ${selectedTime}`);
        ...
        <div>
          <div className="mb-6">
            ...
            <h3 className="text-lg font-medium mt-4">
              Select a time for {selectedDate.toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' })}
            </h3>
          </div>
        ...
        <div className="bg-gray-50 p-6 rounded-lg">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center justify-between py-3 border-b border-gray-200">
              ...
              <span className="font-medium">Online Counseling</span>
            </div>
