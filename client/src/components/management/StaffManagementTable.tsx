                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center bg-gray-100 rounded-lg p-1">
                        <button
                            ...
                            className={`flex items-center gap-1 px-3 py-1 rounded-md transition-colors ${viewMode === 'list'
                        ...
                        <button
                            ...
                            className={`flex items-center gap-1 px-3 py-1 rounded-md transition-colors ${viewMode === 'calendar'
                                    ? 'bg-white text-gray-900 shadow-sm'
                                    : 'text-gray-600 hover:text-gray-900'
                                }`}
                        >
