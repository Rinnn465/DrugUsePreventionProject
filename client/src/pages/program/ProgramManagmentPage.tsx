...
const EventManagmentPage: React.FC = () => {
    ...
    return (
        <div>
            <h1 className="text-4xl font-bold mb-4">Quản lý sự kiện</h1>
                        ...
                        {/* {eventData.map((event) => {
                            return (
                                <div key={event.id}>
                                    ...
                                    <p className="text-sm text-gray-500 mb-2">Thời gian diễn ra: {event.date.toLocaleDateString()}</p>
                                    <p className="text-sm text-gray-500 mb-2">Địa điểm: {event.location}</p>
                                    <p className="text-sm text-gray-500 mb-2">Nhà tổ chức: {event.organizer}</p>
