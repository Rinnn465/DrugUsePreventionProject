                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center">
                                        <TrendingUp className={`h-4 w-4 mr-1 ${stat.changeType === 'positive' ? 'text-green-500' : 
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="font-semibold">{analyticsData.projectsByStatus.completed}</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <div className="flex items-center">
                                ...
                                <span className="font-semibold">{analyticsData.projectsByStatus.inProgress}</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <div className="flex items-center">
                                    <div className="w-3 h-3 bg-yellow-500 rounded mr-2"></div>
                                    <span className="text-sm text-gray-600">Lập kế hoạch</span>
                                </div>
                                <span className="font-semibold">{analyticsData.projectsByStatus.planning}</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <div className="flex items-center">
                                ...
                                <span className="font-semibold">{analyticsData.projectsByStatus.onHold}</span>
                            </div>
                        </div>
                    </div>

                    {/* Chart 2: Impact Metrics */}
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                        ...
                        <div className="space-y-4">
                            <div className="flex justify-between items-center">
                                <span className="text-sm text-gray-600">Trường học tiếp cận</span>
                                <span className="font-semibold text-lg">{analyticsData.impactMetrics.schoolsReached}</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-sm text-gray-600">Học sinh tác động</span>
                                <span className="font-semibold text-lg">
                                    {analyticsData.impactMetrics.studentsImpacted.toLocaleString()}
                                </span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-sm text-gray-600">Buổi tư vấn</span>
                                <span className="font-semibold text-lg">{analyticsData.impactMetrics.consultationsSessions}</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-sm text-gray-600">Tài liệu phát</span>
                                <span className="font-semibold text-lg">
                                    {analyticsData.impactMetrics.materialDistributed.toLocaleString()}
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <div className="h-32 flex items-end justify-between space-x-1">
                            {analyticsData.monthlyTrend.map((value, index) => (
                                <div key={index} className="flex-1 bg-purple-200 rounded-t relative">
                                    <div 
                        ...
                        <div className="flex justify-between mt-2 text-xs text-gray-500">
                            {['T6', 'T7', 'T8', 'T9', 'T10', 'T11', 'T12'].map((month, index) => (
